...
//		File file2 = new File(ProjectMyPath.path + "\\Ex_0203_Java_Project\\src\\menu_information\\CafeMenuInfo" + "/Drink");
		// 집
		File file = new File("CafeMenuInfo" + "/Coffee");
		File file2 = new File("CafeMenuInfo" + "/Drink");
...
//+ coffeeFileName.get(i) + ".jpg");
			// 집
			File img_file = new File("CafeMenuInfo\\Coffee/"+ coffeeFileName.get(i) + ".jpg");
...
//					+ drinkFileName.get(i) + ".jpg");
			// 집
			File img_file2 = new File("CafeMenuInfo\\Drink/"+ drinkFileName.get(i) + ".jpg");
		...
		// 학원
		File objectFile_ice_coffee = new File("CafeMenuInfo" + "/CoffeeObjectSave(Ice)/");
		File objectFile_hot_coffee = new File("CafeMenuInfo" + "/CoffeeObjectSave(Hot)/");
		// 집
...
//		File objectFile_hot_coffee = new File(ProjectMyPath.path + "\\Ex_0203_Java_Project\\src\\menu_information\\CafeMenuInfo" + "/CoffeeObjectSave(Hot)/");
		...
		// 학원
		File objectFile_ice_drink = new File("CafeMenuInfo" + "/DrinkObjectSave(Ice)/");
		File objectFile_hot_drink = new File("CafeMenuInfo" + "/DrinkObjectSave(Hot)/");
		// 집
